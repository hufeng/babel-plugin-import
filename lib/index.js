      ...
      if (Array.isArray(opts)) {
        plugins = opts.map(function (_ref3) {
          var libraryName = _ref3.libraryName,
              ...
              moduleResolver = _ref3.moduleResolver;

          (0, _assert2.default)(libraryName, 'libraryName should be provided');
          return new _Plugin2.default(libraryName, libraryDirectory, moduleResolver, types);
        });
      } else {
        opts = opts || {};
        (0, _assert2.default)(opts.libraryName, 'libraryName should be provided');
        plugins = [new _Plugin2.default(opts.libraryName, opts.libraryDirectory, opts.moduleResolver, types)];
      }
    }
    applyInstance('Program', arguments, this);
  }

  var methods = ['ImportDeclaration', 'CallExpression', 'MemberExpression', 'Property', 'VariableDeclarator', 'LogicalExpression', 'ConditionalExpression', 'IfStatement', 'ExpressionStatement', 'ExportDefaultDeclaration', 'NewExpression'];
