    ...
    if (!plugins) {
      if (Array.isArray(opts)) {
        plugins = opts.map(function (_ref3) {
          ...
          return new _Plugin2.default(libraryName, libraryDirectory, resources, style, types);
        });
      } else {
        opts = opts || {};
        (0, _assert2.default)(opts.libraryName, 'libraryName should be provided');
        plugins = [new _Plugin2.default(opts.libraryName, opts.libraryDirectory, opts.resources, opts.style, types)];
      }
    }
